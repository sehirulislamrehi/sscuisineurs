                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{Str::limit($specialities->description, 50)}}
                                </td>
                                <td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <img src="{{ asset('images/specialities/'. $specialities->image) }}"  width="100px" alt="">  <br> <br>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label> Title</label>
                                                            <input type="text" class="form-control" name="title" value="{{$specialities->title}}">               
                                                            </div>                  
                                                        </div>     
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label> Description</label>
                                                            <textarea name="description" rows="5" class="form-control">{{$specialities->description}}</textarea>                               
                                                            </div>   
                                                        </div>  
