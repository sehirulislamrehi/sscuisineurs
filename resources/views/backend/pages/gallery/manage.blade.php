                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- edit start -->
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit{{ $gallery->id }}">
                                        edit
                                    </button>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('galleryUpdate', $gallery->id) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Gallery Image *</label> <br> <br>
                                                                    <img src="{{ asset('images/gallery/'. $gallery->image) }}" width="100px" alt=""> <br> <br>
                                    ...
                                    <!-- delete start -->
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete{{ $gallery->id }}">
                                        delete
                                    </button>
                                    <div class="modal fade" id="delete{{ $gallery->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h3 class="modal-title" id="exampleModalLabel">gallery delete</h3>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="{{ route('galleryDelete', $gallery->id) }}" method="post">
                                                        @csrf
