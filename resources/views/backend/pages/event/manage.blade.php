                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if( $event->image != NULL )
                                    <img src="{{ asset('images/event/'.$event->image) }}" class="img-fluid" width="50px" alt="">
                                    @else
                                ...
                                <!-- edit start -->
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit{{ $event->id }}">
                                    edit
                                </button>
                                <div class="modal fade" id="edit{{ $event->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="exampleModalLabel">event</h3>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <img src="{{ asset('images/event/'. $event->image) }}"  width="100px" alt="">  <br> <br>
                                ...
                                <div class="modal fade" id="delete{{ $event->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="exampleModalLabel">event delete</h3>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
